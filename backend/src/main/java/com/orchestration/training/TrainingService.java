...
public class TrainingService {
  ...
  private TrainingAttempt evaluateAttempt(TrainingAttempt attempt, String answer) {
    // 답안 null/공백은 여기서 막아야 한다 — 이 아래 해시 계산(TrainingAiEvaluator.sha256)이
    // null에 NPE(500)를 던지고, 공백은 NPE는 안 나지만 캐시 미스라 그대로 유료 AI 채점
