...
type Panel = 'sources' | 'archive' | 'agents' | 'usage' | 'digest' | 'ask' | 'settings' | 'help' | 'timeline' | 'files' | 'graph' | 'processes' | 'trading' | 'kr-trading' | 'us-trading' | 'momentum-rotation-trading' | 'calendar' | 'cheatsheet' | 'users' | 'debate' | null
